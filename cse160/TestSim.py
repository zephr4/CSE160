...
class TestSim:
    ...
    def testClient(self, source, srcPort, destination, destPort, numOfBytes):
        self.sendCMD(self.CMD_TEST_CLIENT, source, "{0}{1}{2}{3}".format(chr(srcPort), chr(destination), chr(destPort), chr(numOfBytes)));
...
def main():
    ...
    s.testServer(4, 19);
    s.runTime(50);
    s.testClient(2, 17, 4, 19, 5);
    s.runTime(50);
    # NOT YET IMPLEMENTED IN TRANSPORT.CLOSE()
    s.clientClose(2, 17, 4, 19);
    s.runTime(200);
